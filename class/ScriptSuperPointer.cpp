...
//	//}
//
//	void CScriptSuperPointerMgr::SetClassInfo(int classindex, CScriptClassInfo* pInfo)
//	{
//		//m_MutexTypeLock.lock();
...
//		{
//			CScriptClassInfo* pInfo = it->second;
//			if (pInfo)
//			{
...
//		return pResult;
//	}
//	CScriptClassInfo const* CScriptSuperPointerMgr::GetBaseClassInfo(int classindex)
//	{
//		auto it = m_mapTypeInfo.find(classindex);
//		if (it != m_mapTypeInfo.end())
//		{
