...
//	public:
//		static CScriptClassInfo s_Info;
//	};
//
//	template<class T>
//	CScriptClassInfo CScriptSuperPointer<T>::s_Info;
//
//	template<class T>
...
//
//		void SetClassInfo(int classindex, CScriptClassInfo* pInfo);
...
//		CScriptClassInfo const* GetBaseClassInfo(int classindex);
//
//		CBaseScriptVarMgr* GetClassMgr(int nType);
//		CBaseScriptVarMgr* GetClassMgr(std::string strType);
//	private:
//		int nClassTypeCount;
//		std::map<std::string, int> m_mapString2ClassType;
//		std::unordered_map<__int64, CScriptBasePointer*> m_mapPointer;
//
//		std::map<int, CScriptClassInfo*> m_mapTypeInfo;
//
//		std::map<int, CBaseScriptVarMgr*> m_mapClassMgr;
//
...
//			p->GetBaseClassInfo(CScriptSuperPointer<T>::s_Info);
//
//			CScriptSuperPointerMgr::GetInstance()->SetClassInfo(CScriptSuperPointer<T>::s_Info.nClassType,
//																&CScriptSuperPointer<T>::s_Info);
//			
//
//			return true;
//		}
